...
var lastMessage = document.querySelectorAll("#user-message p");

for (var i = 0; i < lastMessage.length; i++) {
  var k = lastMessage[lastMessage.length - 1];
  console.log(k);
...
/******/ });
//# sourceMappingURL=application-db6f2476736017b06f83.js.map