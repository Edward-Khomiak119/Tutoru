...
// Module
exports.push([module.i, ".list--chat {\n  margin: 110px auto 100px;\n  width: 1100px;\n  padding: 20px;\n  overflow-y: auto; }\n  .list--chat .list_users {\n    list-style-type: none; }\n  .list--chat .chat_item p {\n    width: 60%;\n    border-radius: 20px;\n    padding: 30px 20px;\n    margin: 10px 10px 10px auto;\n    border-bottom-right-radius: 0;\n    border-color: #EBFDFF;\n    background-color: #EBFDFF;\n    position: relative;\n    font-weight: 400;\n    font-size: 13px; }\n  .list--chat .chat_item p span:first-child {\n      width: 42px;\n      padding: 0;\n      margin: 0;\n      background-color: inherit;\n      font-size: 15px;\n      position: absolute;\n      top: 3px;\n      left: 13px;\n      font-weight: bold;\n      padding-top: 5px;\n      color: #047ac9; }\n  .list--chat .chat_item p span:last-child {\n      width: 120px;\n      right: 0;\n      position: absolute;\n      bottom: 7px;\n      font-size: 9px;\n      font-style: italic; }\n  .list--chat .chat_item .chat_gray_bg {\n    background-color: #f1f1f1;\n    margin: 10px auto 10px 10px;\n    border-bottom-left-radius: 0;\n    border-bottom-right-radius: 20px; }\n  .list--chat .container::after {\n    content: \"\";\n    clear: both;\n    display: table; }\n  .list--chat .message_input {\n    position: relative; }\n  .list--chat .message_input .message_body {\n      border-color: rgba(155, 246, 255, 0.4);\n      border-radius: 55px;\n      resize: none;\n      margin-top: 40px;\n      padding: 15px 15px 15px 26px;\n      width: 100%;\n      min-height: 100px;\n      outline: 0;\n      box-sizing: border-box;\n      padding-right: 80px; }\n  .list--chat .message_input .actions {\n      border: none;\n      position: absolute;\n      top: 75px;\n      right: 40px;\n      background-color: transparent; }\n  .list--chat .message_input .actions input[type=\"submit\"] {\n      background-image: url(" + ___CSS_LOADER_URL___0___ + ");\n      background-color: #fff;\n      border: none;\n      font-size: 0;\n      background-repeat: no-repeat;\n      cursor: pointer;\n      width: 40px;\n      height: 40px; }\n", "",{"version":3,"sources":["/home/scrumfatory/school/tutoru/app/javascript/stylesheets/form_chats_page.scss"],"names":[],"mappings":"AAAA;EACI,wBAAwB;EACxB,aAAa;EACb,aAAa;EACb,gBAAgB,EAAA;EAJpB;IAOM,qBAAqB,EAAA;EAP3B;IAWM,UAAU;IACV,mBAAmB;IACnB,kBAAkB;IAClB,2BAA2B;IAC3B,6BAA6B;IAC7B,qBAAqB;IACrB,yBAAyB;IACzB,kBAAkB;IAClB,gBAAgB;IAChB,eAAe,EAAA;EApBrB;MAuBQ,WAAW;MACX,UAAU;MACV,SAAS;MACT,yBAAyB;MACzB,eAAe;MACf,kBAAkB;MAClB,QAAQ;MACR,UAAU;MACV,iBAAiB;MACjB,gBAAgB;MAChB,cAAc,EAAA;EAjCtB;MAqCS,YAAY;MACZ,QAAQ;MACR,kBAAkB;MAClB,WAAW;MACX,cAAc;MACd,kBAAkB,EAAA;EA1C3B;IA+CM,yBAAyB;IACzB,2BAA2B;IAC3B,4BAA4B;IAC5B,gCAAgC,EAAA;EAlDtC;IAsDM,WAAW;IACX,WAAW;IACX,cAAc,EAAA;EAxDpB;IA4DM,kBAAkB,EAAA;EA5DxB;MA+DQ,sCAAsC;MACtC,mBAAmB;MACnB,YAAY;MACZ,gBAAgB;MAChB,4BAA4B;MAC5B,WAAW;MACX,iBAAiB;MACjB,UAAU;MACV,sBAAsB;MACtB,mBAAmB,EAAA;EAxE3B;MA4EQ,YAAY;MACZ,kBAAkB;MAClB,SAAS;MACT,WAAW;MACX,6BAA6B,EAAA;EAhFrC;MAoFQ,+CAA+C;MAC/C,sBAAsB;MACtB,YAAY;MACZ,YAAY;MACZ,4BAA4B;MAC5B,eAAe;MACf,WAAW;MACX,YAAY,EAAA","file":"form_chats_page.scss","sourcesContent":[".list--chat {\n    margin: 110px auto 100px;\n    width: 1100px;\n    padding: 20px;\n    overflow-y: auto;\n\n    .list_users {\n      list-style-type: none;\n    }\n\n    .chat_item p {\n      width: 60%;\n      border-radius: 20px;\n      padding: 30px 20px;\n      margin: 10px 10px 10px auto;\n      border-bottom-right-radius: 0;\n      border-color: #EBFDFF;\n      background-color: #EBFDFF;\n      position: relative;\n      font-weight: 400;\n      font-size: 13px;\n\n      span:first-child {\n        width: 42px;\n        padding: 0;\n        margin: 0;\n        background-color: inherit;\n        font-size: 15px;\n        position: absolute;\n        top: 3px;\n        left: 13px;\n        font-weight: bold;\n        padding-top: 5px;\n        color: #047ac9;\n      }\n\n       span:last-child {\n         width: 120px;\n         right: 0;\n         position: absolute;\n         bottom: 7px;\n         font-size: 9px;\n         font-style: italic;\n       }\n     }\n\n    .chat_item .chat_gray_bg {\n      background-color: #f1f1f1;\n      margin: 10px auto 10px 10px;\n      border-bottom-left-radius: 0;\n      border-bottom-right-radius: 20px;\n    }\n\n    .container::after {\n      content: \"\";\n      clear: both;\n      display: table;\n    }\n\n    .message_input {\n      position: relative;\n\n      .message_body {\n        border-color: rgba(155, 246, 255, 0.4);\n        border-radius: 55px;\n        resize: none;\n        margin-top: 40px;\n        padding: 15px 15px 15px 26px;\n        width: 100%;\n        min-height: 100px;\n        outline: 0;\n        box-sizing: border-box;\n        padding-right: 80px;\n      }\n\n      .actions {\n        border: none;\n        position: absolute;\n        top: 75px;\n        right: 40px;\n        background-color: transparent;\n      }\n\n      .actions input[type=\"submit\"] {\n        background-image: url(\"../images/telegram.svg\");\n        background-color: #fff;\n        border: none;\n        font-size: 0;\n        background-repeat: no-repeat;\n        cursor: pointer;\n        width: 40px;\n        height: 40px;\n      }\n    }\n  }\n"]}]);
...
/******/ });
//# sourceMappingURL=application-4e796b727ba4a1b1f6b6.js.map