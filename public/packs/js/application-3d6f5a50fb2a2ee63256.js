...
/***/ "./app/javascript/javascript/send_messege_chats.js":
/*!*********************************************************!*\
  !*** ./app/javascript/javascript/send_messege_chats.js ***!
  \*********************************************************/
/*! no static exports found */
...
var containerForMessageBody = document.createElement('p');
var wrapperForMessages = document.querySelector('#user-message');
var inputMessages = document.querySelector('#user-message-input p textarea');
var windowScroll = document.getElementById('user-message');
console.log(windowScroll);
alert(windowScroll);

window.onload = function () {
  var windowScroll = document.getElementById("user-message");
  windowScroll.scrollBottom = windowScroll.scrollHeight;
};

console.log(containerForMessageBody);
containerForMessageBody.innerHTML = "<%= @message.body %>";
wrapperForMessages.appendChild(containerForMessageBody);
inputMessages.value = "";
...
/* harmony import */ var _javascript_send_messege_chats_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../javascript/send_messege_chats.js */ "./app/javascript/javascript/send_messege_chats.js");
/* harmony import */ var _javascript_send_messege_chats_js__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_javascript_send_messege_chats_js__WEBPACK_IMPORTED_MODULE_15__);
...
/******/ });
//# sourceMappingURL=application-3d6f5a50fb2a2ee63256.js.map