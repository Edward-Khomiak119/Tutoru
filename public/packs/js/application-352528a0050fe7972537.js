...
var lastMessage = document.querySelectorAll("#user-message p")[lastMessage.length - 1];
console.log(lastMessage); // for (let i = 0; i < lastMessage.length; i++) {
//   let k = lastMessage[lastMessage.length - 1];
//   console.log(k);
//   console.log(k.style.height);
// }
...
/******/ });
//# sourceMappingURL=application-352528a0050fe7972537.js.map